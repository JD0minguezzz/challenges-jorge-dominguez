...
public class Huffman {
    ...
    private static final String INPUT_FILE = System.getProperty("user.dir")+"\\"+"data/dijk.txt";
    private static final String ENCODED_FILE = System.getProperty("user.dir")+"\\"+"data/encodedDijk.txt";
    private static final String DECODED_FILE = System.getProperty("user.dir")+"\\"+"data/decodedDijk.txt";
    private static final String OUTPUT_FILE = System.getProperty("user.dir")+"\\"+"data/outputDijk.txt";
    
    private static final String INPUT_FILE2 = System.getProperty("user.dir")+"\\"+"data/shortest.txt";
    private static final String ENCODED_FILE2 = System.getProperty("user.dir")+"\\"+"data/encodedShort.txt";
    private static final String DECODED_FILE2 = System.getProperty("user.dir")+"\\"+"data/decodedShort.txt";
    private static final String OUTPUT_FILE2 = System.getProperty("user.dir")+"\\"+"data/outputShort.txt";
