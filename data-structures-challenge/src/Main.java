...
public class Main {
    ...
    public static void main(String[] Args) throws InvalidNodeIDException, IOException, NodeAlreadyExistsException, NodeDoesNotExistException {
    	huff = new Huffman();
        readFileNodes("data/input.txt", map, graph);
        readFileEdges("data/input.txt", map, graph);
        //graph.printEdges();
        ...
        dijkstra.add("=============================\r\n");
        huff.writeFile(System.getProperty("user.dir")+"\\"+"data/dijk.txt", dijkstra);
        shortestRoad.add(graph.shortestPath(9, 5));
        shortestRoad.add("=============================\r\n");
        huff.writeFile(System.getProperty("user.dir")+"\\"+"data/shortest.txt",shortestRoad);
        huff.main(null);
